...
CLASS ltcl_abap_unit_depen_construc DEFINITION FINAL FOR TESTING
  DURATION SHORT
  RISK LEVEL HARMLESS.
  ...
  PRIVATE SECTION.
    ...
    DATA mo_cut TYPE REF TO ycl_abap_unit_depen_construc.
ENDCLASS.


CLASS ltcl_abap_unit_depen_construc IMPLEMENTATION.
